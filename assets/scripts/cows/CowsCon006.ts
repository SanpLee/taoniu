...
@ccclass('CowsCon006')
export class CowsCon006 extends Component {
    ...
    onLoad () {
        ...
        this.node.children[1].children[0].getComponent(Label).string = '6';
        const animationComponent = this.node.children[0].addComponent(Animation);
        loader.loadResDir("cows/c6", SpriteFrame, function (err:any, assets:[], urls:string) {
