...
@ccclass('CowsCon004')
export class CowsCon004 extends Component {
    ...
    onLoad () {
        ...
        this.node.children[1].children[0].getComponent(Label).string = '4';
        const animationComponent = this.node.children[0].addComponent(Animation);
        loader.loadResDir("cows/c4", SpriteFrame, function (err:any, assets:[], urls:string) {
