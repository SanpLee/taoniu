...
@ccclass('CowsCon003')
export class CowsCon003 extends Component {
    ...
    onLoad () {
        ...
        this.node.children[1].children[0].getComponent(Label).string = '3';
        const animationComponent = this.node.children[0].addComponent(Animation);
        loader.loadResDir("cows/c3", SpriteFrame, function (err:any, assets:[], urls:string) {
