...
@ccclass('CowsCon007')
export class CowsCon007 extends Component {
    ...
    onLoad () {
        ...
        this.node.children[1].children[0].getComponent(Label).string = '7';
        const animationComponent = this.node.children[0].addComponent(Animation);
        loader.loadResDir("cows/c7", SpriteFrame, function (err:any, assets:[], urls:string) {
