...
@ccclass('CowsCon002')
export class CowsCon002 extends Component {
    ...
    onLoad () {
        ...
        this.node.children[1].children[0].getComponent(Label).string = '2';
        const animationComponent = this.node.children[0].addComponent(Animation);
        loader.loadResDir("cows/c2", SpriteFrame, function (err:any, assets:[], urls:string) {
