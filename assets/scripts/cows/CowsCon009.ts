...
@ccclass('CowsCon009')
export class CowsCon009 extends Component {
    ...
    onLoad () {
        ...
        this.node.children[1].children[0].getComponent(Label).string = '9';
        const animationComponent = this.node.children[0].addComponent(Animation);
        loader.loadResDir("cows/c9", SpriteFrame, function (err:any, assets:[], urls:string) {
