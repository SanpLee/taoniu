...
@ccclass('CowsCon001')
export class CowsCon001 extends Component {
    ...
    onLoad () {
        ...
        this.node.children[1].children[0].getComponent(Label).string = '1';
        const animationComponent = this.node.children[0].addComponent(Animation);
        loader.loadResDir("cows/c1", SpriteFrame, function (err:any, assets:[], urls:string) {
