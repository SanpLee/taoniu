...
@ccclass('CowsCon008')
export class CowsCon008 extends Component {
    ...
    onLoad () {
        ...
        this.node.children[1].children[0].getComponent(Label).string = '8';
        const animationComponent = this.node.children[0].addComponent(Animation);
        loader.loadResDir("cows/c8", SpriteFrame, function (err:any, assets:[], urls:string) {
