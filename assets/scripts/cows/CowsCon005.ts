...
@ccclass('CowsCon005')
export class CowsCon005 extends Component {
    ...
    onLoad () {
        ...
        this.node.children[1].children[0].getComponent(Label).string = '5';
        const animationComponent = this.node.children[0].addComponent(Animation);
        loader.loadResDir("cows/c5", SpriteFrame, function (err:any, assets:[], urls:string) {
